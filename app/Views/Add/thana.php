      ...
      <div class="row">
        <div class="col-md-6 mx-auto">
          ...
          <form id="thanaAdd">
            ...
            <div class="form-group">
              <label for="thana-en">Thana Name in English:</label>
              <input type="text" class="form-control" id="thana-en" required placeholder="Enter Thana Name" />
            </div>
            <div class="form-group">
              <label for="thana-bn">Thana Name in Bengali:</label>
              <input type="text" class="form-control" id="thana-bn" pattern="[\u0980-\u09FF\s]*" required placeholder="বাংলাতে থানার নাম লিখুন" />
            </div>
...
//fetch divisions
  ...
  let form =document.getElementById("thanaAdd");
  form.addEventListener('submit',function(e){
         e.preventDefault();
         let disId=dis.value;
         let enName=document.getElementById("thana-en").value;
         let bnName=document.getElementById('thana-bn').value;

         if(disId==""||enName==""||bnName=="")
         {
         ...
         // console.log(data);
          ...
          fetch('<?=site_url('/api/create-thana')?>',{
            method:"POST",
            headers:{
